...
// let infoLeitor = [0];
console.log("O livro favorito de "+ leitor.nome +" "+ leitor.sobrenome + " se chama "+"'" +leitor['livrosFavoritos'][0]['titulo']+"'."); //[] índice do array para acessar elemento

// 7 - Adicione um novo livro favorito na chave livrosFavoritos , que é um array . Atribua a esta chave um objeto contendo as seguintes informações:
leitor.livrosFavoritos.push( { //push para add no array enão sobrescrever
